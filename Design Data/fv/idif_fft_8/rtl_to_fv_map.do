...
# Generated on: Tue Nov 07 00:42:25 IST 2023 (Mon Nov 06 19:12:25 UTC 2023)
...
set_log_file fv/idif_fft_8/rtl_to_fv_map.log -replace

usage -auto -elapse

set_verification_information rtl_fv_map_db

read_implementation_information fv/idif_fft_8 -revised fv_map
...
read_design  -define SYNTHESIS  -merge bbox -golden -lastmod -noelab -verilog2k  idif_fft_8.v bbfly4_4.v bbfly2_4.v
elaborate_design -golden -root {idif_fft_8} -rootonly -rootonly  

read_design -verilog95   -revised -lastmod -noelab fv/idif_fft_8/fv_map.v.gz
elaborate_design -revised -root {idif_fft_8}
...
#add_name_alias fv/idif_fft_8/fv_map.singlebit.original_name.alias.json.gz -revised
...
set lec_version_required "19.10100"
if {$lec_version >= $lec_version_required} {
analyze_results -logfiles fv/idif_fft_8/rtl_to_fv_map.log
}
