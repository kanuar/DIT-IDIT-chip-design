...
# Generated on: Tue Nov 07 00:50:49 IST 2023 (Mon Nov 06 19:20:49 UTC 2023)
...
set_log_file fv/dit_fft_8/rtl_to_fv_map.log -replace

usage -auto -elapse

set_verification_information rtl_fv_map_db

read_implementation_information fv/dit_fft_8 -revised fv_map
...
read_library -liberty -both /home/cmos/Desktop/DSD_FINAL_PROJECT/saed90nm_typ.lib /home/cmos/Desktop/DSD_FINAL_PROJECT/saed90nm_typ.lib
...
read_design  -define SYNTHESIS  -merge bbox -golden -lastmod -noelab -verilog2k  add.v mul.v sub.v bfly2_4.v bfly4_4.v dit_fft_point8.v
elaborate_design -golden -root {dit_fft_8} -rootonly -rootonly  

read_design -verilog95   -revised -lastmod -noelab fv/dit_fft_8/fv_map.v.gz
elaborate_design -revised -root {dit_fft_8}
...
#add_name_alias fv/dit_fft_8/fv_map.singlebit.original_name.alias.json.gz -revised
...
set lec_version_required "19.10100"
if {$lec_version >= $lec_version_required} {
analyze_results -logfiles fv/dit_fft_8/rtl_to_fv_map.log
}
