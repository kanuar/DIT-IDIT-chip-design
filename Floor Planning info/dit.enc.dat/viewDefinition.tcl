...
create_delay_corner -name max\
   -library_set max\
   -rc_corner cap
create_constraint_mode -name dit\
   -sdc_files\
    [list /dev/null]
create_analysis_view -name setup -constraint_mode dit -delay_corner max
create_analysis_view -name hold -constraint_mode dit -delay_corner min
