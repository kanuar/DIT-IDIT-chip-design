...
# Generated on: Wed Nov 08 00:33:14 IST 2023 (Tue Nov 07 19:03:14 UTC 2023)
...
set_log_file fv/four_fft/rtl_to_fv_map.log -replace

usage -auto -elapse

set_verification_information rtl_fv_map_db

read_implementation_information fv/four_fft -revised fv_map
...
read_library -liberty -both /home/install/FOUNDRY/digital/45nm/LIBS/lib/max/slow.lib
...
read_design  -define SYNTHESIS  -merge bbox -golden -lastmod -noelab -verilog2k  /home/cmos/Desktop/DSD_project_only_floor_planning/design_idif.v
elaborate_design -golden -root {four_fft} -rootonly 

read_design -verilog95   -revised -lastmod -noelab fv/four_fft/fv_map.v.gz
elaborate_design -revised -root {four_fft}
...
set lec_version_required "19.10100"
if {$lec_version >= $lec_version_required} {
analyze_results -logfiles fv/four_fft/rtl_to_fv_map.log
}
